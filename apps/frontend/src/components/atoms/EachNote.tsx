...
const EachNote: FC<EachNoteProps> = ({
  ...
  return (
    <div className="group flex gap-2">
      ...
      >
        <div
          className={`flex items-center justify-between gap-x-4 rounded-lg border p-2 ${isActive ? "border-border bg-secondary" : "border-transparent hover:bg-secondary"} text-sm text-tertiary-foreground`}
        >
