  ...
  return (
    <div className="mx-4 my-auto flex select-none flex-col items-center justify-center rounded-[30px] border border-border bg-background px-2 py-8">
      ...
      >
        ...
        {isHovered && (
          <>
        <div className="hidden hover:flex flex-col gap-0.5 mt-4">
        {/* Voice Recording */}
<div className={classNames(navLinkClassName, "text-secondary-foreground")}
     role="button"
     tabIndex={0}
...
>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    <g fill="none">
      ...
      <path fill="currentColor" d="M12 3a1 1 0 0 1 .993.883L13 4v16a1 1 0 0 1-1.993.117L11 20V4a1 1 0 0 1 1-1M8 6a1 1 0 0 1 1 1v10a1 1 0 1 1-2 0V7a1 1 0 0 1 1-1m8 0a1 1 0 0 1 1 1v10a1 1 0 1 1-2 0V7a1 1 0 0 1 1-1M4 9a1 1 0 0 1 1 1v4a1 1 0 1 1-2 0v-4a1 1 0 0 1 1-1m16 0a1 1 0 0 1 .993.883L21 10v4a1 1 0 0 1-1.993.117L19 14v-4a1 1 0 0 1 1-1" />
    </g>
  </svg>
     </div>
</div>
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <SidebarLink
            ...
            label="Mode"
            isActive={pathname.includes("/mode/")}
            mouseY={mouseY}
          />
      {/* info*/}
        <div
